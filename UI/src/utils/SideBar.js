const SideBar = ({ response, title,onClick }) => {
  console.log("dummy====>", response, title);
  return (
                ...
                >
                  ...
                  {/* <thead className="bg-slight-white">
                    {response.length > 0 && (
                      <tr className="border-slight-grey">
                        {Object.keys(response[0]).map((item) => {
                          return <th scope="col" style={{ width: 10 }} key={item}>{item}</th>;
                        })}
                      </tr>
                    )}
                  </thead> */}
                    ...
                    {response?.map((item) => (
                      <tr className="border-slight-grey">
                        {Object.values(item).map((val) => (
                          <td className="td-grey-col"  key={val._id}>{val}</td>
                        ))}
                        <td>
                          <button className="btn btn-sm btn-soft-info" onClick={()=>{onClick(item._id)}}>
                            Approve Now
                          </button>
                    ...
                    <form action="#">
                      <div className="row">
                        ...
                        <div className="col-lg-4">
                          <div className="mb-3">
                            <label htmlFor="cityidInput" className="form-label">
                              City
                            </label>
                            <input
                              type="text"
