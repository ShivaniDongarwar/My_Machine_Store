...
const SideBar = ({
  ...
  return (
    <>
                ...
                >
                  <div className="gridjs-head">
                    ...
                    <div className="hstack gap-2">
                      {AddVendorLink && (
                        <Link className="btn btn-primary" to={AddVendorLink}>
                  ...
                  <div className="gridjs-wrapper" style={{ height: "auto" }}>
                    {URL === "/enquiry/superAdminProductList" ? (
                      <ProductList productListResponse={response} columns={columns}/>
                    ) : (
                      <table
                        role="grid"
      ...
      {/* {URL === "/enquiry/superAdminProductList" ? <ProductList productListResponse={}/> : ""} */}
    </>
  );
};
