                  ...
                  <div className="row g-2">
                    <div className="col-xl-3">
                      <div className="page-title1-box d-sm-flex align-items-center justify-content-between">
                        <h4 className="mb-sm-0">Enquiry List</h4>
                      </div>
                    </div>
                    {/*end col*/}
                      ...
                      <table id="example" className="table table-bordered dt-responsive nowrap table-striped align-middle" style={{ width: '100%' }}>
                          ...
                          <tr className="border-slight-grey">
                            <th scope="col" style={{ width: 10 }}>
                              <div className="form-check">
                                <input className="form-check-input fs-15" type="checkbox" id="checkAll" defaultValue="option" />
                              </div>
                            </th>
                        ...
                        <tbody className="bg-slight-white">
                          <tr className="border-slight-grey">
                            <th scope="row">
                              <div className="form-check">
                                <input className="form-check-input fs-15" type="checkbox" name="checkAll" defaultValue="option1" />
                              </div>
                            </th>
                            ...
                            <td className="td-grey-col">
                              <button className="btn btn-sm btn-soft-info">Approve Now</button>
                              <button className="btn btn-sm btn-soft-warning">Deny</button>
                            </td>
                          </tr>
                          <tr className="border-slight-grey">
                            <th scope="row">
